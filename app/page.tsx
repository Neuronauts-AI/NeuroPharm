    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Doktor Reçete Paneli</h1>
          ...
          {selectedPatient ? (
              ...
              {selectedMedicines.length > 0 && (
                <div className="mt-6 flex gap-4">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-semibold transition-colors"
                  >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">Hasta Seçilmedi</h3>
